...
public class customerService {
	...
	public Mono<Object> save(customer obj) {
		...
		if (typeCustomers.empresial().equals(obj.getType()) || typeCustomers.personal().equals(obj.getType())) {
			try {
	...
	public Mono<Object> update(String id, String dni, String firstname, String lastname, String typecustomer) {
		if (repository.existsById(id)) {
	...
	public Mono<Object> register(String dni, String firstname, String lastname, String typecustomer) {
	...
	public Mono<Object> searchByDni(String dni) {
		if (repository.existsByDni(dni)) {
			...
			return Mono.just(new message("Dni no encontrado."));
		}
	}
